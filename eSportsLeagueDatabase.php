...
//
//    $player_team = executePlainSQL("SELECT teamName FROM Player WHERE inGameName='" . $in_game_name . "'
//                                    AND playerName='" . $player_name . "'");
//    $Team = oci_fetch_row($player_team);
//
//    executePlainSQL("DELETE FROM Player WHERE inGameName='" . $in_game_name . "' AND playerName= '" . $player_name . "'");
//
//    $numberOfTuples = executePlainSQL("SELECT * FROM Player WHERE teamName ='" . $Team[0] . "'");
//
////    $num = oci_fetch_row($numberOfTuples);
//
//    echo "<br> Deleted Player With Gamertag: " . $in_game_name . " & Player Name: " . $player_name . " <br>";
//
//    if ((oci_fetch_row($numberOfTuples)) != true) {
//        return executePlainSQL("Delete FROM Team WHERE teamName='" . $Team[0] . "'");
//        echo "<br>Deleted Team: " . $Team[0] . " .<br>";
//    }
//
